    ...
    <section id="projects" className="py-5">
      <div className="container">
        ...
        <div className="navigation-buttons text-center mb-4">
          <a href="#javascript-projects" className="btn btn-custom mx-2">JavaScript Projects</a>
          <a href="#react-projects" className="btn btn-custom mx-2">React Projects</a>
          <a href="#android-projects" className="btn btn-custom mx-2">Android Projects</a>
          <a href="#python-projects" className="btn btn-custom mx-2">Python Projects</a>
        </div>
