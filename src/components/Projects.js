              ...
              <div className="col-md-6 col-lg-4 mb-4">
                <div className="card h-100">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">Meet Here is a Video Conferencing App which allows users to make video calls. (Framework Used: React Native).</p>
              ...
              <div className="col-md-6 col-lg-4 mb-4">
                <div className="card h-100">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">Registration Form is a simple form that allows users to fill in information and submit it. (Library Used: React JS).</p>
              ...
              <div className="col-md-6 col-lg-4 mb-4">
                <div className="card h-100">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">Expense Tracker is an Android application that allows users to track their daily and monthly expenses. (Language Used: Java and XML).</p>
              ...
              <div className="col-md-6 col-lg-4 mb-4">
                <div className="card h-100">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">Quiz Game allows users to select their interests and play a quiz based on their chosen interests. (Language Used: Java and XML). </p>
              ...
              <div className="col-md-6 col-lg-4 mb-4">
                <div className="card h-100">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">Sign Up and Login Page allows users to log in to the app with proper authentication. (Language Used: Java, XML, Firebase).</p>
              ...
              <div className="col-md-6 col-lg-4 mb-4">
                <div className="card h-100">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">Guess the Word is a Python-based game that allows users to guess words for different things. (Language Used: Python)</p>
              ...
              <div className="col-md-6 col-lg-4 mb-4">
                <div className="card h-100">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">Soduku Solver is a Python-based project that solves any Sudoku puzzle given as input. (Language Used: Python).</p>
              ...
              <div className="col-md-6 col-lg-4 mb-4">
                <div className="card h-100 ">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">Scientific Calculator is a Python-based calculator with a graphical user interface developed using Tkinter. (Language Used: Python)</p>
